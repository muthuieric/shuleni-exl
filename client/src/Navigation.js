  ...
  return (
    <nav className="bg-white shadow-lg">
      ...
      <div className="hidden mobile-menu">
        <ul>
          <li className="active">
            <button className="block text-sm px-2 py-4 text-white bg-green-500 font-semibold">Home</button>
          </li>
          <li>
            <button className="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Services</button>
          </li>
          <li>
            <button className="block text-sm px-2 py-4 hover-bg-green-500 transition duration-300">About</button>
          </li>
          <li>
            <button className="block text-sm px-2 py-4 hover-bg-green-500 transition duration-300">Contact Us</button>
          </li>
        </ul>
      </div>
    </nav>
